function init() {
    ...
    d3.json("restaurantData.json").then((data) => {
  ...
  function buildCharts(sample) {
    ...
    d3.json("restaurantData.json").then((data) => {
      ...
      var Income_level= firstSample.income_level;
      var boroughName= firstSample.borough;
      console.log(Score);
      ...
      //var yticks = Zipcode.slice(0,10).map(id => "zipcode" + id).reverse();
      console.log(yticks);
